<html lang="en">
    ...
    <body class="container"> <!--onload="multiplyNode(document.getElementsByClassName('col-md-12')[0], 3, true);" -->
                ...
                <div class="col-md-12"> <!-- A RÉPLIQUER -->
                    ...
                    foreach($keys as $key) {
                        ...
                        <div class="card-body">
                            ...
                            <a href="index.php?ctl=bucket&action=decrement&product='. $key .'" class="btn btn-primary cart-btn"> 
                            ...
                            <a href="index.php?ctl=bucket&action=delete&product='. $key .'" class="btn btn-del btn-primary cart-btn">
                    ...
                    <div class="card entry">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text product-description">Petite description du produit, c'est très bon et pas du tout cher, achetez le. Merci bien.</p>
                            <a href="#" class="btn btn-del btn-primary submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                </svg>
        ...
        <div class="card bucket">
            ...
            <div class="card-body">
                <!--h5 class="card-title">Total de vos achats</h5-->
